...
export const VERANA_REST_ENDPOINT_TRUST_REGISTRY = read('NEXT_PUBLIC_VERANA_REST_ENDPOINT_TRUST_REGISTRY')
export const VERANA_REST_ENDPOINT_CREDENTIAL_SCHEMA = read('NEXT_PUBLIC_VERANA_REST_ENDPOINT_CREDENTIAL_SCHEMA')
export const VERANA_REST_ENDPOINT_PERM = read('NEXT_PUBLIC_VERANA_REST_ENDPOINT_PERM')
export const VERANA_REST_ENDPOINT_DID = read('NEXT_PUBLIC_VERANA_REST_ENDPOINT_DID')
