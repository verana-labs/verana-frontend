...
import {
  MSG_ERROR_ACTION_TR,
  MSG_INPROGRESS_ACTION_TR,
  MSG_SUCCESS_ACTION_TR,
...
export function useActionTR(onCancel?: () => void, onRefresh?: (id?: string, txHeight?: number) => void) {
  ...
  async function actionTR(
    params: ActionTRParams,
