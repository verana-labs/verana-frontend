...
export default function CorporationPage() {
  ...
  if (actingLoading || (actingCorporation && loading)) {
  ...
  const updateMode = corporationSigningMode('/verana.co.v1.MsgUpdateCorporation', actingCorporation)
  const grantMode = corporationSigningMode('/verana.de.v1.MsgGrantOperatorAuthorization', actingCorporation)
  const revokeMode = corporationSigningMode('/verana.de.v1.MsgRevokeOperatorAuthorization', actingCorporation)
  const repayMode = corporationSigningMode('/verana.td.v1.MsgRepaySlashedTrustDeposit', actingCorporation)
        ...
        {rotating && updateMode ? (
          <form
            ...
            onSubmit={(event) => {
              ...
              if (didDraft.trim()) {
                void manage.updateCorporationDid(actingCorporation, didDraft.trim())
                setRotating(false)
                setDidDraft('')
              }
            }}
          ...
          {trustDeposit ? (
            <>
              ...
              {unrepaidSlash > 0 && repayMode ? (
                <button
                  type="button"
                  onClick={() => void manage.repaySlashed(actingCorporation, unrepaidSlash)}
              ...
              {operatorAuthorizations.map((authorization) => (
                <li key={authorization.id} className="py-2 flex items-center justify-between gap-3 text-sm">
                  ...
                  {revokeMode ? (
                    <button
                      type="button"
                      onClick={() => void manage.revokeOperator(actingCorporation, authorization.operator)}
              ...
              <form
                ...
                onSubmit={(event) => {
                  ...
                  if (granteeDraft.trim()) {
                    void manage.grantOperator(actingCorporation, granteeDraft.trim(), [...OPERATOR_GRANT_MESSAGE_TYPES])
                    setGranteeDraft('')
                  }
                }}
              >
      ...
      {tab === 'proposals' ? (
        <Card>
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            {actingCorporation.member && !composing ? (
              <button
                type="button"
