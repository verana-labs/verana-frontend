    ...
    >
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          <h3 className="text-base font-semibold text-gray-900 dark:text-white mb-1">{roleObject?.label}</h3>
          <p className="text-sm text-neutral-70 dark:text-neutral-70">{roleObject?.description}</p>
        </div>
      </div>
    </div>
  )
