  ...
  return (
    <section className="mb-8">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">
        {resolveTranslatable({ key: 'featuredservices.title' }, translate)}
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {links
          ...
          .map((link, idx: number) => (
            <div
              key={`FeaturedServices-${idx}`}
              className="bg-white dark:bg-surface rounded-xl border border-neutral-20 dark:border-neutral-70 overflow-hidden hover:shadow-lg transition-shadow duration-200 flex flex-col h-full"
            >
