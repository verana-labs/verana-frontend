...
export const didSections: Section<DidData>[] = [
  ...
  },
  {
    ...
    fields: [
      {
        name: 'renewDID',
        label: t('dataview.did.actions.renew.label'),
        type: 'action',
        description: t('dataview.did.actions.renew.desc'),
        icon: faCalendarPlus,
      ...
      {
        name: 'touchDID',
        label: t('dataview.did.actions.touch.label'),
        type: 'action',
        description: t('dataview.did.actions.touch.desc'),
        icon: faHandPointer,
      ...
      {
        name: 'removeDID',
        label: t('dataview.did.actions.remove.label'),
        type: 'action',
        description: t('dataview.did.actions.remove.desc'),
        icon: faTrash,
