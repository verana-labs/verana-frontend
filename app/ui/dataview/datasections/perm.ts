...
const commonCreateFields = (opts?: {
  includeType?: boolean
  includeValidatorPermId?: boolean
      ...
      return [
        {
          name: t('dataview.perm.sections.main'),
          type: 'basic',
          fields: [...commonIdentityFields(), ...dateFields({ until: true })],
        },
      ]
...
export const permissionSlashing: PermissionItem[] = [
  {
    label: resolveTranslatable({ key: 'permissioncard.slashing.slasheddeposit' }, translate) ?? 'Slashed Deposit',
  ...
  {
    label: resolveTranslatable({ key: 'permissioncard.slashing.repaiddeposit' }, translate) ?? 'Repaid Deposit',
    attr: 'repaid_deposit',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
    hiddenZero: true,
...
export const permissionMetaItems: PermissionItem[] = [
  {
    ...
    extraActions: [
      {
        icon: faCopy,
        label: resolveTranslatable({ key: 'permissioncard.action.copy' }, translate) ?? 'copy',
        value: 'copy',
      },
      // { icon: faEye, label: resolveTranslatable({key: "permissioncard.action.visualizer"}, translate)?? "visualizer", value: "visualizer" },
      {
        icon: faUpRightFromSquare,
        label: resolveTranslatable({ key: 'permissioncard.action.service' }, translate) ?? 'service',
        value: 'service',
      },
    ],
  },
  {
    ...
    extraActions: [
      ...
      {
        icon: faUpRightFromSquare,
        label: resolveTranslatable({ key: 'permissioncard.action.explorer' }, translate) ?? 'explorer',
        value: 'explorer',
      },
    ],
  },
  ...
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.deposit' }, translate) ?? 'Deposit',
    attr: 'deposit',
    mono: true,
    format: (value) => formatVNAFromUVNA(String(value)),
  },
  ...permissionSlashing,
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.participants' }, translate) ?? 'Participants',
    attr: 'participants',
    hiddenZero: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.weight' }, translate) ?? 'weight',
    attr: 'weight',
    format: (value) => formatVNAFromUVNA(String(value)),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.issued' }, translate) ?? 'Issued Credentials',
    attr: 'issued',
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.verified' }, translate) ?? 'Verified Credentials',
    attr: 'verified',
  },
]
...
export const permissionLifecycle: PermissionItem[] = [
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.effectivefrom' }, translate) ?? 'Effective From',
    attr: 'effective_from',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.meta.effectiveuntil' }, translate) ?? 'Effective Until',
    attr: 'effective_until',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.created' }, translate) ?? 'Created',
    attr: 'created',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.createdby' }, translate) ?? 'Created By',
    attr: 'created_by',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.modified' }, translate) ?? 'Modified',
    attr: 'modified',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.modifiedby' }, translate) ?? 'Modified By',
    attr: 'modified_by',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.extended' }, translate) ?? 'Extended',
    attr: 'extended',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.extendedby' }, translate) ?? 'Extended By',
    attr: 'extended_by',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.revoked' }, translate) ?? 'Revoked',
    attr: 'revoked',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.revokedby' }, translate) ?? 'Revoked By',
    attr: 'revoked_by',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.slashed' }, translate) ?? 'Slashed',
    attr: 'slashed',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.slashedby' }, translate) ?? 'Slashed By',
    attr: 'slashed_by',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.repaid' }, translate) ?? 'Repaid',
    attr: 'repaid',
    format: (value) => formatDate(value as string),
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.repaidby' }, translate) ?? 'Repaid By',
    attr: 'repaid_by',
    mono: true,
  },
]
export const permissionActionSlashing: PermissionAction[] = [
  {
    name: 'PERM_SLASH',
    value: 'MsgSlashPermissionTrustDeposit',
    icon: faTriangleExclamation,
    label: resolveTranslatable({ key: 'permissioncard.slashing.action.permslash' }, translate) ?? 'Slash Deposit',
    iconColorClass: 'bg-red-600 hover:bg-red-700',
  },
  {
    name: 'PERM_REPAY',
    value: 'MsgRepayPermissionSlashedTrustDeposit',
    icon: faHandHoldingDollar,
    label:
      resolveTranslatable({ key: 'permissioncard.slashing.action.permrepay' }, translate) ?? 'Repay Slashed Deposit',
...
export const permissionActionLifecycle: PermissionAction[] = [
  {
    name: 'PERM_EXTEND',
    value: 'MsgExtendPermission',
    icon: faClockRotateLeft,
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.action.permextend' }, translate) ?? 'Extend Permission',
  },
  {
    name: 'PERM_REVOKE',
    value: 'MsgRevokePermission',
    icon: faBan,
    label: resolveTranslatable({ key: 'permissioncard.lifecycle.action.permrevoke' }, translate) ?? 'Revoke Permission',
    iconColorClass: 'bg-red-600 hover:bg-red-700',
  },
...
export const permissionValidationProcess: PermissionItem[] = [
  {
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.vplaststatechange' }, translate) ??
      'VP Last State Change',
    attr: 'vp_last_state_change',
  },
  {
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.vpcurrentfees' }, translate) ?? 'VP Current Fees',
    attr: 'vp_current_fees',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
  },
  {
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.vpcurrentdeposit' }, translate) ??
      'VP Current Deposit',
    attr: 'vp_current_deposit',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
  },
  {
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.vpsummarydigestsri' }, translate) ??
      'VP Summary Digest',
    attr: 'vp_summary_digest_sri',
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.validationprocess.vpexp' }, translate) ?? 'VP Expiration',
    attr: 'vp_exp',
    format: (value) => formatDate(value as string),
  },
  {
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.vpvalidatordeposit' }, translate) ??
      'VP Validator Deposit',
    attr: 'vp_validator_deposit',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
  },
]
...
export const permissionActionValidationProcess: PermissionAction[] = [
  {
    name: 'VP_RENEW',
    value: 'MsgRenewPermissionVP',
    icon: faRotate,
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.action.vprenew' }, translate) ??
      'Renew Validation Process',
  },
  {
    name: 'VP_CANCEL',
    value: 'MsgCancelPermissionVPLastRequest',
    icon: faXmark,
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.action.vpcancel' }, translate) ?? 'Cancel Request',
    iconColorClass: 'bg-gray-600 hover:bg-gray-700',
  },
  {
    name: 'VP_SET_VALIDATED',
    value: 'MsgSetPermissionVPToValidated',
    icon: faCheck,
    label:
      resolveTranslatable({ key: 'permissioncard.validationprocess.action.vpsetvalidated' }, translate) ??
...
export const permissionBusinessModels: PermissionItem[] = [
  {
    label: resolveTranslatable({ key: 'permissioncard.businessmodels.validationfees' }, translate) ?? 'Validation Fees',
    attr: 'validation_fees',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
  },
  {
    label: resolveTranslatable({ key: 'permissioncard.businessmodels.issuancefees' }, translate) ?? 'Issuance Fees',
    attr: 'issuance_fees',
    format: (value) => formatVNAFromUVNA(String(value)),
    mono: true,
  },
  {
    label:
      resolveTranslatable({ key: 'permissioncard.businessmodels.verificationfees' }, translate) ?? 'Verification Fees',
...
/**
 * API Pending Flat Permissions payload (dates are ISO strings)
 */
export interface TrustRegistriesPermission {
  id: string
  did: string
  aka?: string | null
