...
export const columnsCsList: Column<CsList>[] = [
  ...
  { header: t("datatable.cs.header.participants"), accessor: "participants", priority: 2 },
  { header: t("datatable.cs.header.issued"), accessor: "issued", priority: 2 },
  { header: t("datatable.cs.header.verified"), accessor: "verified", priority: 2 },
];
